...
for service in idam ccd_user_profile ccd_definition ccd_data evidence ccd_definition_designer role_assignment ts_translation_service dbrefdata dbuserprofile org_role_mapping; do
