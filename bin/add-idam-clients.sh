...
${dir}/utils/idam-create-service.sh "ccd_next_hearing_date_updater" "ccd_next_hearing_date_updater" "AAAAAAAAAAAAAAAA" "http://ccd-next-hearing-day-updater-service/oauth2redirect" "false" "profile openid roles"