...
${dir}/utils/idam-create-service.sh "ccd-case-disposer" "ccd-case-disposer" "idam-case-disposer-client-secret" "http://ccd-case-disposer/oauth2redirect" "false" "profile openid roles"